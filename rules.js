...
export function csvTeam(code){ code=String(code||"").trim().toUpperCase(); return CSV_TEAM[code]||code; }
export function lineKey(week,away,home){ return Number(week)+"|"+csvTeam(away)+"|"+csvTeam(home); }
