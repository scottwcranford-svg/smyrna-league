...
export const state = {
  ...
  draftSubject:"", draftOpp:"", draftOutcome:"playoffs", draftSeasonOutcome:"",   // a league result bet: whose team (and, on a matchup, whose against), what happens, and the season outcome last picked
